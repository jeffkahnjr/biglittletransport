...
```python
user = 'YOUR_USERNAME' #add your username here (same as previous postgreSQL)
host = 'localhost'
password = 'YOUR_PW' #add your password
dbname = 'YOUR_DB_NAME'
...
gmaps.configure(api_key="YOUR_API_KEY") # Insert your own Google Maps API Key
```
